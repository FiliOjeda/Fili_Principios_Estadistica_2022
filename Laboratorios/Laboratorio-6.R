...
# Dentro de los corchetes puede especificar uno o más valores numéricos 
# que correspondan a la(s) posición (es) de los elementos del vector
...
# es un tipo particular de vector que toma los valores especiales
# VERDADERO y FALSO, así como NA(No disponible).
...
# utilizar la notación de corchetes en la columna extraída como
# con cualquier tipo de vector
